...
"""Bootstrap Talos cluster and then deploy OpenChoreo app stack.

This keeps Talos cluster lifecycle under Pulumi in a dedicated project, while the
existing OpenChoreo stack continues consuming kubeconfig_path/context as-is.
"""
...
CLUSTER_DIR = ROOT / "talos-cluster"
APP_DIR = ROOT
DEFAULT_CLUSTER_STACK = "dev"
DEFAULT_CLUSTER_PASSPHRASE = "openchoreo-talos-dev"
...
def main() -> None:
    ...
    print("==> Bootstrapping Talos cluster with Pulumi...")
    ...
    print("==> Deploying OpenChoreo on Talos...")
    run(
        [
            "pulumi",
            "up",
