...
```bash
curl -fsSL https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.0/install/k3d/common/values-thunder.yaml \\
...
```bash
kubectl apply -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.0/samples/getting-started/workflow-templates/publish-image.yaml
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.0/samples/getting-started/workflow-templates/generate-workload.yaml \\
...
- Explore the [sample applications](https://github.com/openchoreo/openchoreo/tree/$release-v1.0/samples)
